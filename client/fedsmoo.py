...
class fedsmoo(Client):
    def __init__(self, device, model_func, received_vecs, dataset, lr, args):   
        ...
        self.base_optimizer = self._get_optimizer(self.model.parameters(), optimizer_name=self.args.optimizer, lr=lr, weight_decay=self.args.weight_decay + self.args.lamb)
